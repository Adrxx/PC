    ...
    function echoActividades() {
		...
		{		
			...
			echo '<div id="activity">
					...
					<div id="titulo_activity_imp"> A&uacute;n no hay actividades realizadas.</div> 
					
					<div id="content_activity" >

						<div id="descripcion_activity"></div>
        ...
        foreach ($actividades as $a) {
            $act = new Actividad($a->getID());
			
			$fotos = $act->getFotos();
            $aliado = new Aliado($act->getIDAliado());
            echo '<div id="activity"><table id="header_activity">' . 
                '<tr><td width="60"><div id="categoria_activity">' .
                '</div></td><td><div id="titulo_activity">' .
                $act->getNombre() .
                ...
                '<div id="month">' .
                $act->getFechaInicioTrabajo() .
                '</div><div id="day">' .
                $act->getFechaInicioTrabajo() .
                '</div></div></td></tr></table><div class="separator">' .
                '</div><div id="content_activity" ><div id="descripcion_activity">' .
                $act->getDescripcion() .
                '</div><div id="fotos_activity"><div id="SPP1" >' . 
                '<img class="foto" src="'.$fotos[0].'"/>' .
                '</div><div id="SPP2" >' .
                '<img class="foto" src="'.$fotos[1].'"/>' .
                '</div><div id="SPP3" >' .
                '<img class="foto" src="'.$fotos[2].'"/>' .
                '</div></div>' .
                '<script> generateSmartPane("fotos_activity");</script>' .
                '</div></div>';
        }
    }
